...
<body class="theme-red">
    ...
    <script src="{{secure_asset('plugins/jquery-countto/jquery.countTo.js')}}"></script>
    ...
    <!-- ChartJs -->
    <script src="{{secure_asset('plugins/chartjs/Chart.bundle.js')}}"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="{{secure_asset('plugins/flot-charts/jquery.flot.js')}}"></script>
    <script src="{{secure_asset('plugins/flot-charts/jquery.flot.resize.js')}}"></script>
    <script src="{{secure_asset('plugins/flot-charts/jquery.flot.pie.js')}}"></script>
    <script src="{{secure_asset('plugins/flot-charts/jquery.flot.categories.js')}}"></script>
    <script src="{{secure_asset('plugins/flot-charts/jquery.flot.time.js')}}"></script>

    <!-- Sparkline Chart Plugin Js -->
    <script src="{{secure_asset('plugins/jquery-sparkline/jquery.sparkline.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{secure_asset('js/admin.js')}}"></script>
    <script src="{{secure_asset('js/pages/index.js')}}"></script>
